...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
    <legend style="color:red;font-size:25px;">创建小组</legend>
    </fieldset>
<%
...
<span style="color:blue; font-family:楷体 ;font-size:30px"><%=message %></span><br><br>
   <form class="layui-form" action="doSet_Group.jsp">
  ...
  <div class="layui-form-item">
    <div class="layui-input-block">
      <button class="layui-btn" lay-submit lay-filter="formDemo"style="font-size:20px;width:300px;height:80px;margin-left:80px;">立即创建</button>
    </div>
  </div>
</form>
</div>

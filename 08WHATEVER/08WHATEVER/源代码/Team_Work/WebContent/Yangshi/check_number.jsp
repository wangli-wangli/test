...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
    ...
    <a href="studentFind.jsp" class="layui-btn" style="background:red;float:right;">返回</a> 
...
for(int h_id:h_ids)
{
	...
	%>
	<a href="<%=request.getContextPath()%>/calculate/excuseZuoti.jsp?h_id=<%=h_id%>"><button class="layui-btn" style="width:200px;height:100px; "><h1 style="font-size:30px"><%=h_id %></h1></button> <span>发布时间 ：<%=time %></span><br></a>

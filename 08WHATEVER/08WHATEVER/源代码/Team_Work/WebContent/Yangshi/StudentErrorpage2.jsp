...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
    <legend style="color:red;font-size:25px;">错题记录（日）</legend>
    </fieldset>
    <a href="StudentErrorpage1.jsp" class="layui-btn" style="background:red;float:right;">返回</a> 

<form  action="StudentErrorpage3.jsp"> 

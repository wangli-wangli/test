...
<form action="teacherFind'.jsp" method="post">
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
    <legend style="color:red;font-size:25px;">查看小组</legend>
    </fieldset>
  ...
  <% 
     ...
     {
    	 %>
    	 <input class="layui-btn"  type="submit" name="group" value="<%=group %>" style="font-size:30px;width:200px;height:100px; "> <br><br>

...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
    <legend style="color:red;font-size:25px;">更新用户信息</legend>
    </fieldset>
     <%    
...
%>
<form class="layui-form" action="update.jsp">
  <input type="hidden" name="id" value="<%=user.getU_Id()%>"/>
   &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <span style="color:blue; font-family:楷体 ;font-size:20px"><%=Meg %></span>
  <div class="layui-form-item">
    <label class="layui-form-label"><h2>名字:</h2></label>
    <div class="layui-input-inline">
      <input type="text" name="姓名" value="<%=user.getU_Name()%>" placeholder=""   autocomplete="off" class="layui-input" style="font-size:20px;width:400px;height:50px;color:gray">
    </div>
  </div>
  <div class="layui-form-item">
   <label class="layui-form-label"><h2>昵称:</h2></label>
    <div class="layui-input-inline">
      <input type="text" name="昵称" value="<%=user.getU_Nickname()%>" placeholder=""  autocomplete="off" class="layui-input"style="font-size:20px;width:400px;height:50px;color:gray">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label"><h2>密码:</h2></label>
    <div class="layui-input-inline">
      <input type="text" name="密码" value="<%=user.getU_Password()%>"  placeholder="" autocomplete="off" class="layui-input"style="font-size:20px;width:400px;height:50px;color:gray">
    </div>
    <br><br><br>
    <div class="layui-form-item">

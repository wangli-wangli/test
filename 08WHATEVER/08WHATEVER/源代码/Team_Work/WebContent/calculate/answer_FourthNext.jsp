...
<%
  ...
  int operationNumber=(Integer)session.getAttribute("num1");//题目的总个数
   ...
   for(int i=0;i<operationNumber;i++)
   {
	   ...
	   double inputResult2=0;
	   if(inputResult.equals(""))
	   {
		  inputResult2=2147483647;//int型的最大值
	   }
	   else
	   {
		  inputResult2=Double.valueOf(inputResult); 
	   }
	   double CorrectResult2=Double.valueOf(CorrectResult);
	   %>
	   
	   <%=Question %><%=inputResult %>
	   <% 
	   if(inputResult2==CorrectResult2)
	   {
